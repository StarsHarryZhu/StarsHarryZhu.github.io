<template>
  <section id="about" class="about-section" aria-label="About">
    ...
    <div class="about-grid">
      <article class="glass about-panel reveal" :ref="reveal.observe" :style="{ '--reveal-delay': '100ms' }">
      ...
      <aside class="glass about-side reveal" :ref="reveal.observe" :style="{ '--reveal-delay': '220ms' }" aria-label="Focus areas">
...
const socialItems = computed(() => props.contacts)
</script>
